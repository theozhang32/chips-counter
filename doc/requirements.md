...
| FR-107 | 快捷下注数值：由系统根据本金自动生成、动态调整（按本金比例推导档位，如本金 1000 → 100 / 200 / 500 / 1000，另含全下），不提供任何人为配置入口；具体档位规则在详细设计中细化 | P0 |
...
| NFR-07 | 部署 | 普通个人电脑即可运行，供本地 / 局域网使用，无需专门服务器或付费第三方服务 |
...
| AC-03 | 下注三种输入 | 快捷数值选项随本金自动生成（本金 1000 → 100 / 200 / 500 / 1000），且房间设置中无快捷值配置项；全下（金额自动等于剩余筹码并打标记）、手动输入均生效；下注金额 ＞ 当前筹码时操作被拒绝，筹码与池不变 |
